using iCrabee.BackendServer.Controllers;
...
namespace iCrabee.BackendServer.UnitTest.Controllers
{
    public class FunctionsControllerTest
    {
        ...
        {
            var usersController = new FunctionsController(_context, _mockLogger.Object);
